...
(* Internal={l1,l2};
External={k1,k2,k4};
Propagators={l1^2,(-k1+l1)^2,(-k1-k2+l1)^2,(l2+k1+k2)^2,(l2-k4)^2,l2^2,(l1+l2)^2,(l1+k4)^2,(l2+k1)^2};
Replacements={k1^2->0,k2^2->0,k4^2->0,k1 k2->s/2,k1 k4->t/2,k2 k4->(-s-t)/2} *)


(* SymanzikPolynomials[Internal,External,Propagators,Replacements,{1,1,1,1,1,1,1,0,0}][[2]]//Factor
PolynomialSymmetry[%,z/@Range[7]] *)


(* FeynmanParameterization[Internal,External,Propagators,Replacements,{1,1,1,1,1,5,1,0,0},SplitOutput\[Rule]True]//Factor *)


(* Sector 'Structure' is {Internal,External,Propagators,Replacements, SectorIndex} *)
